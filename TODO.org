...
* Development plan
** TODO Refactor Configuration spec so that it's clear that counters bind to instruments
** TODO What are improvements of JFugue 4.1 compared to 4.0.3?
SCHEDULED: <2013-04-19 Fri>
